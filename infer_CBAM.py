...
if __name__ == '__main__':
    ...
    parser.add_argument("--weights", default='./train_from_clc_weight/CBAM_RRM_final.pth', type=str)
    parser.add_argument("--network", default="network.CBAM", type=str)
    parser.add_argument("--out_cam_pred", default='./output(CBAM)/result/no_crf', type=str)
    parser.add_argument("--out_la_crf", default='./output(CBAM)/result/crf', type=str)
