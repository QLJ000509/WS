...
if __name__ == '__main__':
    ...
    parser.add_argument("--weights", default='./train_from_clc_weight/SEAM_RRM_final.pth', type=str)
    parser.add_argument("--network", default="network.SEAM", type=str)
    parser.add_argument("--out_cam_pred", default='./output(SEAM)/result/no_crf', type=str)
    parser.add_argument("--out_la_crf", default='./output(SEAM)/result/crf', type=str)
