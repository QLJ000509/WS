...
class Net(nn.Module):
    def __init__(self):
        ...
        self.SC64 = ScConv(64, 4, 0.5,1 / 2, 2, 2, 3)
        self.SC128 = ScConv(128, 4, 0.5, 1 / 2, 2, 2, 3)
        self.SC256 = ScConv(256, 4, 0.5, 1 / 2, 2, 2, 3)
        self.SC512 = ScConv(512, 4, 0.5, 1 / 2, 2, 2, 3)
        self.SC1024 = ScConv(1024, 4, 0.5, 1 / 2, 2, 2, 3)
        self.SC2048 = ScConv(2048, 4, 0.5, 1 / 2, 2, 2, 3)
        self.SC4096 = ScConv(4096, 4, 0.5, 1 / 2, 2, 2, 3)
    ...
    def forward_as_dict(self, x):
        ...
        x = self.conv1a(x)#(64,321,321)
        x = self.SC64(x)

        x = self.b2(x)#(128,161,161)
        x = self.SC128(x)
        x = self.b2_1(x)#(128,161,161)
        x = self.SC128(x)
        x = self.b2_2(x)#(128,161,161)
        x = self.SC128(x)

        x = self.b3(x)#(256,81,81)
        x = self.SC256(x)
        x = self.b3_1(x)#(256,81,81)
        x = self.SC256(x)
        x = self.b3_2(x)#(256,81,81)
        x = self.SC256(x)

        x = self.b4(x)#(512,41,41)
        x = self.SC512(x)
        x = self.b4_1(x)#(512,41,41)
        x = self.SC512(x)
        x = self.b4_2(x)#(512,41,41)
        x = self.SC512(x)
        x = self.b4_3(x)#(512,41,41)
        x = self.SC512(x)
        x = self.b4_4(x)#(512,41,41)
        x = self.SC512(x)
        x = self.b4_5(x)#(512,41,41)
        x = self.SC512(x)

        x, conv4 = self.b5(x, get_x_bn_relu=True)#(1024,41,41),(512,41,41)
        x = self.SC1024(x)
        x = self.b5_1(x)#(1024,41,41)
        x = self.SC1024(x)
        x = self.b5_2(x)#(1024,41,41)
        x = self.SC1024(x)

        x, conv5 = self.b6(x, get_x_bn_relu=True)##(2048,41,41),(1024,41,41)
        x = self.SC2048(x)

        x = self.b7(x)#(4096,41,41)
        x = self.SC4096(x)
        conv6 = F.relu(self.bn7(x))#(4096,41,41)
