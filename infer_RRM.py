...
if __name__ == '__main__':
    ...
    parser.add_argument("--weights", default='./train_from_clc_weight/RRM_final.pth', type=str)
    parser.add_argument("--network", default="network.RRM", type=str)
    parser.add_argument("--out_cam_pred", default='./output(RRM)/result/no_crf', type=str)
    parser.add_argument("--out_la_crf", default='./output(RRM)/result/crf', type=str)
